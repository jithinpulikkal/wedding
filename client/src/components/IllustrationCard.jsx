                ...
                {imageSrc ? (
                    <div className=" w-full">
                        <img
                            src={imageSrc}
                            alt={imageAlt || title}
                            className="w-full max-h-full rounded-2xl border border-gold/30 object-cover shadow-glow "
                            loading="lazy"
                        />
                    </div>
                ) : (
                    <div className="mb-7 h-36 w-36 animate-floatSoft rounded-full border border-gold/30 bg-gradient-to-br from-gold/30 via-ivory to-white shadow-glow" />
                )}
