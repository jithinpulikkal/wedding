...
export default function IllustrationCard({
    ...
    return (
        <Reveal animation="scaleIn">
            <div className="relative overflow-hidden rounded-3xl border border-gold/30 bg-gradient-to-br from-ivory via-surface to-ivory shadow-royal">
                ...
                <div className="relative flex h-full flex-col items-center justify-center p-8 text-center sm:p-10 lg:p-12">
                    {imageSrc ? (
                        ...
                        <div className="mb-7 h-36 w-36 rounded-full border border-gold/30 bg-gradient-to-br from-gold/30 via-ivory to-surface shadow-glow motion-safe:animate-floatSoft" />
                    )}
